# Public API draft (v2 architecture notes, superseded)
...
>
> Superseded 2026-09-18 by the one page [API.md](./API.md) (ROADMAP decision 5). Kept for the architecture notes. Quick start: see [CREATING_A_SPECIES.md](./CREATING_A_SPECIES.md) · v1 reference: [API_V1.md](./API_V1.md) · Architecture: [SOUND_WORLD_ENGINE.md](./SOUND_WORLD_ENGINE.md)
